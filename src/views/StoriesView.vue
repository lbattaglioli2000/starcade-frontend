        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
            ...
            <div class="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
              ...
              <a @click="creatingNewStory = !creatingNewStory" class="ml-6 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-rose-600 hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500"> New Story </a>
              <NewStorySlideover :open="creatingNewStory" />
...
import { BellIcon, HomeIcon, MenuIcon, XIcon } from "@heroicons/vue/outline";
import Stories from "../components/stories/Stories.vue";
import NewStorySlideover from "../components/stories/NewStorySlideover.vue";
...
const navigation = [
  ...
  // { name: 'Newly Added', href: '#', icon: FireIcon, current: false },
...
const tabs = [
  ...
  { name: 'Most Read', href: '#', current: false },
]
const whoToFollow = [
  {
