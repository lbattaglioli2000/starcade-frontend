                ...
                <div class="h-0 flex-1 overflow-y-auto">
                  <div class="bg-indigo-700 py-6 px-4 sm:px-6">
                    <div class="flex items-center justify-between">
                      <DialogTitle class="text-lg font-medium text-white"> New Story </DialogTitle>
                    ...
                    <div class="mt-1">
                      <p class="text-sm text-indigo-300">Get started by filling in the information below to create your new story. If you want to invite contributors to help you write your story, you may do so here.</p>
                    </div>
                  </div>
                  <div class="flex flex-1 flex-col justify-between">
                    <div class="divide-y divide-gray-200 px-4 sm:px-6">
                      <div class="space-y-6 pt-6 pb-5">
                        <div>
                          <label for="project-name" class="block text-sm font-medium text-gray-900"> Story title </label>
                          <div class="mt-1">
                        ...
                        <div>
                          <label for="description" class="block text-sm font-medium text-gray-900"> Synopsis </label>
                          <div class="mt-1">
                          ...
                          <div class="mt-2 space-y-5">
                            <div class="relative flex items-start">
                              ...
                              <div class="pl-7 text-sm">
                                ...
                                <p id="privacy-public-description" class="text-gray-500">Anyone on StarCade will be able to see, and participate in this story.</p>
                              </div>
                            </div>
                            <div>
                              <div class="relative flex items-start">
                                ...
                                <div class="pl-7 text-sm">
                                  ...
                                  <p id="privacy-private-to-project-description" class="text-gray-500">Only contributors you've invited to this story will be able to access it.</p>
                                </div>
                              </div>
                            </div>
                            <div>
                              <div class="relative flex items-start">
                                ...
                                <div class="pl-7 text-sm">
                                  ...
                                  <p id="privacy-private-description" class="text-gray-500">You are the only one able to access this story.</p>
                                </div>
                              </div>
                            </div>
                          </div>
